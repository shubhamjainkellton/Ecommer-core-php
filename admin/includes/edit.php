...
<?php include "db.php"; ?> <?php include "header.php" ?>
<?php                   $cat_id;
                        if(isset($_GET['p_id']))
...
<input class ="btn btn-primary" type="submit" name="submit" value="submit" >
                        ...
                        { 
                            ...
                            $querry = "UPDATE `posts` SET `post_category_id`='$post_Category_id',`post_title`='$title',`post_author`='$author',
                            `post_date`='$post_date',`post_image`='$post_image',`post_content`='$post_content',`post_tags`='$post_tags',
                            `post_status`='$post_status' WHERE `post_id`== '$cat_id' ";
