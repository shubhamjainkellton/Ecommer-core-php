                    ...
                    <div class="col-lg-12">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php 
                                /*if($row['status']==1){
                                echo "<a href='?type=status&operation=deactive&sno=".$row['sno']."'>Active</a>";
                                }else{
                                    echo "<a href='?type=status&operation=active&sno=".$row['sno']."'>Deactive</a>";
                                }*/
                                ?>
                                </td>
                                
                                <td><a href="delete_category.php?sno=<?php echo $sno?>"> Delete </a></td>
                                <td><a href ="update_category.php?sno=<?php echo $sno?>">Update</a></td>
